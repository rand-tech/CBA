# This file includes code from https://github.com/pinksawtooth/CapaExplorer by pinksawtooth.
# The original code is licensed under the MIT License.
# The full license text can be found in https://github.com/pinksawtooth/CapaExplorer/blob/main/LICENSE

#Capa analysis importer for Ghidra.
#@author @reb311ion and @pinksawtooth and @rand6d74
#@keybinding shift O
#@category Analysis
    ...
    for capability in range(0, len(capabilities)):
        ...
        if not 'lib' in meta.keys() or meta['lib'] == False:
            ...
            for match in range(0, len(Matches_list)):
                item = capa_item(Current_namespace, Current_scope, Current_capability, int(Matches_list[match]),
                                 addr_list, attack)
